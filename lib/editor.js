	...
	for (var i = 0; i < children.length; i++) {
		...
		switch (_type) {
			...
			case 'endtag':
				endTag(child.key);
				break;
			case 'Document':   ret.push(Document(child)); break;
			case 'Section':    ret.push(Section(child)); break;
			case 'Fragment':   break; //Fragments don't get rendered in place
			case 'P':          ret.push(P(child)); break;
			case 'H1':         ret.push(H1(child)); break;
			case 'H2':         ret.push(H2(child)); break;
			case 'H3':         ret.push(H3(child)); break;
			case 'Quote':      ret.push(Quote(child)); break;
			case 'PullQuote':  ret.push(PullQuote(child)); break;
			case 'Ulli':
				wtag = 'ul';
			...
			case 'Code':
				...
				ret.push(Code(child));
				break;
			case 'Figure':     ret.push(Figure(child)); break;
			case 'FigCaption': ret.push(FigCaption(child)); break;
			case 'Table':      ret.push(Table(child)); break;
			case 'Image':      ret.push(Image(child)); break;
			default:           ret.push(Node(child)); break;
		};
	};
