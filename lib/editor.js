...
var Editor = createClass({
	...
	didMount: function() {
		...
		if (isIe) ta.addEventListener('beforepaste', this.focusPasteDiv);
	...
	willUnmount: function() {
		...
		if (isIe) ta.removeEventListener('beforepaste', this.focusPasteDiv);
    ...
    ieClipboardEvent: function(clipboardEvent) {
        ...
        if (clipboardEvent == 'paste') {
            ...
            setTimeout(function() {
                ...
                console.log('Clipboard HTML: ' + me.hiddenPasteArea.node.innerHTML);
