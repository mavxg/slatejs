...
var keymap = [
	...
	{keys:["ctrl+i","c"], command:"insert_column", args:{before:true}, context:in_table_context},
	{keys:["ctrl+i","r"], command:"insert_row", args:{before:false}, context:in_table_context},
	{keys:["ctrl+i","d"], command:"insert_column", args:{before:false}, context:in_table_context},
	{keys:["ctrl+i","s"], command:"insert_row", args:{before:true}, context:in_table_context},
	{keys:["enter"], command:"insert_row", args:{before:false}, context:in_table_context},
	{keys:["ctrl+i","t"], command:"insert_table", args:{},
		context:[
			{key:"breakable", operator:"equals", operand:true, match_all:true}
		]},
	//dummy huge table.
	{keys:["ctrl+i","y"], command:"insert_table", args:{rows:1000,cols:5},
		context:[
			{key:"breakable", operator:"equals", operand:true, match_all:true}
		]},
