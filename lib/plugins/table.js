...
var keymap = [
	...
	{keys:["ctrl+n","c"], command:"insert_column", args:{before:true}, context:in_table_context},
	{keys:["ctrl+n","r"], command:"insert_row", args:{before:false}, context:in_table_context},
	{keys:["ctrl+n","d"], command:"insert_column", args:{before:false}, context:in_table_context},
	{keys:["ctrl+n","s"], command:"insert_row", args:{before:true}, context:in_table_context},
	{keys:["enter"], command:"insert_row", args:{before:false}, context:in_table_context},
	{keys:["ctrl+n","t"], command:"insert_table", args:{},
		context:[
			{key:"breakable", operator:"equals", operand:true, match_all:true}
		]},
	//dummy huge table.
	{keys:["ctrl+n","y"], command:"insert_table", args:{rows:1000,cols:5},
		context:[
			{key:"breakable", operator:"equals", operand:true, match_all:true}
		]},
